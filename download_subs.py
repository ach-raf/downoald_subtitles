...
def auto_select_sub(_subtitles_result_list):
    _subtitles_selected = ''
        ...
        for current_language in opt_languages:
            ...
            if ('data' in subtitles_result_list) and (subtitles_result_list['data']):
                ...
                if not subtitles_selected:
                    subtitles_selected = auto_select_sub(subtitles_result_list)
                ...
                if subtitles_selected:
                    ...
                    print(">> Downloading '" + subtitles_result_list['data'][sub_index][
                        'LanguageName'] + "' subtitles for '" + video_title + "'")
